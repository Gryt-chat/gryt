...
## Voice isn't on this page

The page used to show *Voice calls* and *Community voice calls*, pushed from the
WireGuard handshake ages on this box. They came off on 2026-09-14. Read on a public
page, a bare "Voice calls" row looked like Gryt runs voice for everyone, and the only
Gryt server the page speaks for is the community one, which *Community server* already
covers.
