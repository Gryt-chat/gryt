...
const PAGES = [
  { path: "packages/docs/content/docs/build/server-plugin-api.mdx", build: serverPage },
  { path: "packages/docs/content/docs/build/addon-api.mdx", build: clientPage },
  { path: "packages/docs/content/docs/build/bot-api.mdx", build: botPage },
];
